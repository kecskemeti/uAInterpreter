...
public class UBInt extends UBContainer<Integer> {
	public UBInt(int loc, String val, boolean adr) {
		super(loc, Integer.parseInt(val), adr);
	}

	public UBInt(int loc, String val) {
		this(loc, val, false);
	}
